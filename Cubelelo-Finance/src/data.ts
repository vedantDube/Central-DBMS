...
const zeroChannel = (id: string, name: string, category: ChannelFinancials["category"]): ChannelFinancials => ({
  ...
  aov: 0, ordersPerDay: 0, unitsPerOrder: 0, totalOrders: 0, unitsSold: 0, listingsCount: 0, activeListingCount: 0, revenuePerSku: 0,
  outOfStockDays: 0, stockoutCost: 0, ageingInventoryPct: 0, deadStockPct: 0,
